...
--
-- Dumping data for table `favorite_musics`
--

LOCK TABLES `favorite_musics` WRITE;
/*!40000 ALTER TABLE `favorite_musics` DISABLE KEYS */;
INSERT INTO `favorite_musics` VALUES
(2,'3wJHCry960drNlAUGrJLmz','ヨルシカ',0.962,0.834,'jfieifajeifiejf');
/*!40000 ALTER TABLE `favorite_musics` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2022-06-24 19:13:25
