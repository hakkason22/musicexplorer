            ...
            <div class="favorite_list_field">
                ...
                <div class="favorite_infos">
                    <div class="favorite_info" v-for="favoriteMusicInfo in favoriteMusicInfos" :key="favoriteMusicInfo.music_id">
                        <input type="radio" :id="favoriteMusicInfo.music_id" :value="favoriteMusicInfo.music_id" v-model="selected_music_id">
...
export default Vue.extend({
    ...
    methods:{
        ...
        addChart(){
            const targetMusicInfo = this.favoriteMusicInfos.find(element => element.music_id === this.selected_music_id)
